...
var Pokemon = /*#__PURE__*/function () {
  ...
  function Pokemon(pokemonName, pokemonType, pokemonAttack) {
    _classCallCheck(this, Pokemon);
    _classPrivateFieldInitSpec(this, _hp, {
      writable: true,
      value: 100
    });
    this.name = pokemonName, this.type = pokemonType, this.attack = pokemonAttack;
  }
  _createClass(Pokemon, [{
    key: "attackPokemon",
    value: function attackPokemon() {
      console.log("O Pekemon ".concat(this.name, " atacou com ").concat(this.attack, "! "));
    }
  }, {
    key: "receivedAttack",
...
var Pikachu = /*#__PURE__*/function (_Pokemon) {
  ...
  function Pikachu() {
    ...
    return _super.call(this, 'Pikachu', 'Eletric', 'Choque do trovao');
  }
